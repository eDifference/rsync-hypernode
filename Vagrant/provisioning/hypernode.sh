...
if [ "$magento_ver" == "2" ]; then
	# Create magento 2 nginx flag file
	su app -c 'touch /data/web/nginx/magento2.flag'
	...
	su app -c "ln -fs /data/web/magento2/pub /data/web/public"
fi
...
echo "Or visit https://$(echo `hostname` | cut -d'-' -f2).dev.cream.nl in your browser"